...
import DialogModalStore from "../../../stores/useDialogModalStore.jsx";
    ...
    const newErrors = {
      ...
      6:
        !user.firstName || !user.lastName
          ? intl.formatMessage({
              id: "nameRequired",
              defaultMessage: "First name and last name are required",
            })
          : "",
      7: !user.laboratoryId
        ? intl.formatMessage({
            id: "laboratoryRequired",
            defaultMessage: "Laboratory is required",
          })
        : "",
      8: passwordStrongEnough
        ? ""
        : intl.formatMessage({
      ...
      <form className={styles.registrationForm}>
        <div className={styles.formContent}>
          <div className={styles.formSection1}>
            ...
            <FormattedMessage id="lastNamePlaceholder">
              {(value) => (
                <input
                  className={styles.input}
                  type="text"
            ...
            <div className={styles.btnDiv}>
              <Button
                ...
                backgroundColor={"var(--btn-background2)"}
              />
              <Button
                path="/"
                tradId="back"
