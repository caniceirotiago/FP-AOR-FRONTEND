    ...
    <div className={styles.initialPage}>
      <div className={styles.content}>
        <div className={styles.welcomeBoard}>
          ...
          <div className={styles.buttons}>
            ...
            <Button
              path="/homepage"
              tradId="enterTheApplication"
              defaultText="Enter The Application"
            />
          </div>
        </div>
      </div>
      <div className={styles.appPresentation}>
        <div className={styles.cardContainer}>
          ...
          <div
            ref={ref}
            className={`${styles.card2} ${inView ? styles.slideIn : ""}`}
          >
            <div className={styles.card2ImageSection}>
              <img
                className={styles.card2IMG}
                src={card2IMG}
                alt="Description of the app"
              />
            </div>
            <div className={styles.card2TextSection}>
              <h3>
                <FormattedMessage
                  id="appDescription"
                  defaultMessage="Innovation Lab Management System"
                />
              </h3>
              <p>
                <FormattedMessage
                  id="appDetails"
                  defaultMessage="Our application facilitates the creation, management, and tracking of innovative projects in a collaborative environment. Features include user profiles, project management, resource allocation, and secure communication channels."
                />
              </p>
            </div>
          </div>
              ...
              <Slider {...settings} className={styles.carouselContainer}>
                {laboratories.map((lab) => (
                  <div key={lab.id} className={styles.labCard}>
                    ...
                    <h3>{lab.location}</h3>
                    <Button
                      onClick={() => navigateWithFilter(lab)}
                      tradId="seeLabProjects"
                      defaultText="See Lab Projects"
